...
<Card title="Deploy Now" icon="play" horizontal href="/quickstart">
...
<Card title="Get Netlify API Token" icon="key" horizontal href="https://app.netlify.com/user/applications">
...
<Card title="Get Vercel API Token" icon="key" horizontal href="https://vercel.com/account/tokens">
...
<Card title="Get Supabase Access Token" icon="key" horizontal href="https://app.supabase.com/account/tokens">
...
<Card title="Connect Git Repository" icon="github" horizontal href="#git-setup">
