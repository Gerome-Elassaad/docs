...
<Columns cols={2}>
  <Card
    title="Prompt Mode"
    icon="chat"
    href="/prompting/prompting-effectively"
  >
...
<Columns cols={2}>
  ...
  <Card
    ...
    icon="docker"
    href="/features/development/webcontainer"
  >
  ...
  <Card
    ...
    icon="terminal"
    href="/features/development/terminal"
  >
  ...
  <Card
    ...
    icon="folder"
    href="/features/development/code-editor"
  >
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="plus"
    href="/getting-started/your-first-project"
  >
