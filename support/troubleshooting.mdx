...
<Card title="Get Help Now" icon="question-circle" horizontal href="#contact-support">
...
<AccordionGroup>
  ...
  <Accordion title="Rate limit exceeded" icon="credit-card">
  ...
  <Accordion title="Provider connection failures" icon="exclamation-triangle">
...
<AccordionGroup>
  ...
  <Accordion title="Web version not loading" icon="window">
