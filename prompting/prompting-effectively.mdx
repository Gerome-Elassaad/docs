...
description: "Learn when building with CodinIT.dev, the quality of your results will often depend less on how well you know code."
---
...
<Frame>
  <img
    ...
    src="/assets/images/prompt-comparison.png"
    alt="Screenshot of DNS records management screen within Cloud settings."
  />
</Frame>
